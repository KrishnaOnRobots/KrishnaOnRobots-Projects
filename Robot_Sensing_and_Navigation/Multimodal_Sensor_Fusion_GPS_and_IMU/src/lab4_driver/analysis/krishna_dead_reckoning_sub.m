...
%open bag file
bag = rosbag('/MATLAB Drive/boston_tour.bag');
...
scale_matrix = [0.5999,0.0498;0.0498,0.993];
offset_magx = -0.0719;
offset_magy = 0.212;
...
mag_low_pass= lowpass(unwrapped_mag_yaw, 0.0001, 40);

%high pass filter on gyro yaw
gyro_high_pass = highpass(gyro_yaw,0.0001,40);
