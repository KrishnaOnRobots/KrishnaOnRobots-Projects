...
%open bag file
bag = rosbag('/MATLAB Drive/circles.bag');
...
figure;
scatter(corrected_mag(:,1),corrected_mag(:,2), 5 ,"filled","DisplayName","After calibration");
hold on;
scatter(Mag_x, Mag_y, 5, "filled", "DisplayName", "Before calibration");
hold on;
...
figure;
scatter(imu_time, Mag_x, 5 ,"filled","DisplayName","Before Calibration");
hold on;
scatter(imu_time, corrected_mag(:,1), 5, "filled", "DisplayName", "After calibration");
hold on;
xlabel("Time (s)");
...
figure;
scatter(imu_time, Mag_y, 5 ,"filled","DisplayName","Before Calibration");
hold on;
scatter(imu_time, corrected_mag(:,2), 5, "filled", "DisplayName", "After calibration");
hold on;
xlabel("Time (s)");
ylabel("Magnetic Field Y (Gauss)");
