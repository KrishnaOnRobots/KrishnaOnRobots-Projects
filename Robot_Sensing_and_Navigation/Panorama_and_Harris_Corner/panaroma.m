%buildingDir = 'LAB_5/LSC_new';
%buildingDir = 'LAB_5/Brick';
buildingDir = 'LAB_5/Mural_50pc';
%buildingDir = 'LAB_5/Mural_15pc';
...
k = [2910.64268  0 1973.81845; 0 2909.12087 1131.27324; 0 0 1];

radialDistortion = [0.02055 -0.05806 0]; 
tangentialDistortion = [0.00070 -0.00077];
...
% Initialize variable to hold image sizes.[features, points] = extractFeatures(grayImage,[x,y]);
