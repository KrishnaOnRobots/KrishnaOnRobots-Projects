...
def convert_to_utm(gps_data_str):
    ...
    print("easting, northing, zone_number, zone_letter, altitude, hdop, UTC, GNSS_fix", easting, northing, zone_number, zone_letter, altitude, hdop, UTC, gnss_fix)

    return (time_stamp, easting, northing, zone_number, zone_letter, lat, long, altitude, hdop, UTC, gnss_fix)
